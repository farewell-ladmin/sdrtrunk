...
@JsonSubTypes({
    ...
    @JsonSubTypes.Type(value = DecodeConfigEDACS.class, name = "decodeConfigEDACS"),
    @JsonSubTypes.Type(value = DecodeConfigMotorolaTypeII.class, name = "decodeConfigMotorolaTypeII")
})
